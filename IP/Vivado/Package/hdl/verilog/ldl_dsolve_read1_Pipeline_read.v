...
module ldl_dsolve_read1_Pipeline_read (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [127:0] gmem0_addr_read_reg_139;
reg   [30:0] i_fu_56;
wire   [30:0] add_ln15_fu_106_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_i_load;
reg    ap_block_pp0_stage0_01001;
reg    X_stream_write_local;
wire   [31:0] zext_ln15_fu_96_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln15_fu_100_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        X_stream_write_local = 1'b1;
    end else begin
        X_stream_write_local = 1'b0;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln15_fu_100_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign X_stream_din = gmem0_addr_read_reg_139;

assign X_stream_write = X_stream_write_local;

assign add_ln15_fu_106_p2 = (ap_sig_allocacmp_i_load + 31'd1);
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (1'b0 == X_stream_full_n);
end
...
assign icmp_ln15_fu_100_p2 = (($signed(zext_ln15_fu_96_p1) < $signed(div)) ? 1'b1 : 1'b0);
...
assign zext_ln15_fu_96_p1 = ap_sig_allocacmp_i_load;

endmodule //ldl_dsolve_read1_Pipeline_read
