...
module ldl_dsolve_writeout_Pipeline_write (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [127:0] seks_reg_143;
reg    ap_block_pp0_stage0_01001;
reg   [30:0] i_fu_58;
wire   [30:0] add_ln81_fu_110_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_i_load;
reg    X2_stream_read_local;
wire   [31:0] zext_ln81_fu_100_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln81_fu_104_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
        ...
        X2_stream_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        X2_stream_read_local = 1'b1;
    end else begin
        X2_stream_read_local = 1'b0;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln81_fu_104_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign X2_stream_read = X2_stream_read_local;

assign add_ln81_fu_110_p2 = (ap_sig_allocacmp_i_load + 31'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (1'b0 == X2_stream_empty_n);
end
...
assign icmp_ln81_fu_104_p2 = (($signed(zext_ln81_fu_100_p1) < $signed(div)) ? 1'b1 : 1'b0);
...
assign m_axi_gmem2_WDATA = seks_reg_143;
...
assign zext_ln81_fu_100_p1 = ap_sig_allocacmp_i_load;

endmodule //ldl_dsolve_writeout_Pipeline_write
