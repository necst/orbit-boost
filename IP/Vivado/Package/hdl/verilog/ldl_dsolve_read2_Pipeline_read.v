...
module ldl_dsolve_read2_Pipeline_read (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        D_stream_write_local = 1'b1;
    end else begin
        D_stream_write_local = 1'b0;
    end
end
...
assign D_stream_din = gmem1_addr_read_reg_139;

assign D_stream_write = D_stream_write_local;
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (1'b0 == D_stream_full_n);
end
...
assign icmp_ln23_fu_100_p2 = (($signed(zext_ln23_fu_96_p1) < $signed(div)) ? 1'b1 : 1'b0);
...
endmodule //ldl_dsolve_read2_Pipeline_read
