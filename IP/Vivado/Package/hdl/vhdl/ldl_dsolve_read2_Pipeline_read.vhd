...
entity ldl_dsolve_read2_Pipeline_read is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ldl_dsolve_read2_Pipeline_read is 
...
attribute shreg_extract : string;
    ...
    signal gmem1_addr_read_reg_139 : STD_LOGIC_VECTOR (127 downto 0);
    ...
    signal D_stream_write_local : STD_LOGIC;
...
begin
    ...
    D_stream_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, D_stream_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            D_stream_blk_n <= D_stream_full_n;
        else 
            D_stream_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    D_stream_din <= gmem1_addr_read_reg_139;
    D_stream_write <= D_stream_write_local;

    D_stream_write_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
            D_stream_write_local <= ap_const_logic_1;
        else 
            D_stream_write_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    ap_block_state3_pp0_stage0_iter2_assign_proc : process(D_stream_full_n)
    begin
                ap_block_state3_pp0_stage0_iter2 <= (ap_const_logic_0 = D_stream_full_n);
    end process;
    ...
    icmp_ln23_fu_100_p2 <= "1" when (signed(zext_ln23_fu_96_p1) < signed(div)) else "0";
